...
{
    static const auto sMapping =
        QMap<std::pair<Shader::Language, Shader::ShaderType>, SourceType>{
            { { Shader::Language::GLSL, Shader::ShaderType::Vertex },
                SourceType::GLSL_VertexShader },
            { { Shader::Language::GLSL, Shader::ShaderType::Fragment },
                SourceType::GLSL_FragmentShader },
            { { Shader::Language::GLSL, Shader::ShaderType::Geometry },
                SourceType::GLSL_GeometryShader },
            ...
            { { Shader::Language::GLSL, Shader::ShaderType::Compute },
                SourceType::GLSL_ComputeShader },

            { { Shader::Language::HLSL, Shader::ShaderType::Vertex },
                SourceType::HLSL_VertexShader },
            { { Shader::Language::HLSL, Shader::ShaderType::Fragment },
                SourceType::HLSL_PixelShader },
            { { Shader::Language::HLSL, Shader::ShaderType::Geometry },
                SourceType::HLSL_GeometryShader },
            { { Shader::Language::HLSL,
                  Shader::ShaderType::TessellationControl },
                SourceType::HLSL_HullShader },
            { { Shader::Language::HLSL,
                  Shader::ShaderType::TessellationEvaluation },
                SourceType::HLSL_DomainShader },
            { { Shader::Language::HLSL, Shader::ShaderType::Compute },
                SourceType::HLSL_ComputeShader },
        };
...
Shader::ShaderType getShaderType(SourceType sourceType)
{
    ...
    case SourceType::HLSL_VertexShader: return Shader::ShaderType::Vertex;

    case SourceType::GLSL_FragmentShader:
    case SourceType::HLSL_PixelShader:    return Shader::ShaderType::Fragment;

    case SourceType::GLSL_GeometryShader:
    case SourceType::HLSL_GeometryShader: return Shader::ShaderType::Geometry;
    ...
    case SourceType::HLSL_ComputeShader: return Shader::ShaderType::Compute;
    }
    return {};
}
...
Shader::Language getShaderLanguage(SourceType sourceType)
{
    ...
    case SourceType::GLSL_TessellationControl:
    case SourceType::GLSL_TessellationEvaluation:
    case SourceType::GLSL_ComputeShader:          return Shader::Language::GLSL;
    ...
    case SourceType::HLSL_HullShader:
    case SourceType::HLSL_DomainShader:
    case SourceType::HLSL_ComputeShader:  return Shader::Language::HLSL;
    }
