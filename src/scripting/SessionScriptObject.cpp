...
QVariant SessionScriptObject::ItemObject::updateValue(const QString &key,
...
QJSValue SessionScriptObject::writeTextFile(const QString &fileName,
...
QJSValue SessionScriptObject::readTextFile(const QString &fileName)
{
    auto source = QString{};
